    ...
    module ContactsHelperPatch
      ...
      module InstanceMethods
        ...
        def contact_tabs_with_helpdesk(contact)
          ...
          if contact.tickets.visible.count > 0
            tabs.push({:name => 'helpdesk', :partial => 'contacts/helpdesk_tickets', :label => l(:label_helpdesk_ticket_plural) + " (#{contact.tickets.visible.open.count}/#{contact.tickets.visible.count})"} )
          end
          tabs
        end
